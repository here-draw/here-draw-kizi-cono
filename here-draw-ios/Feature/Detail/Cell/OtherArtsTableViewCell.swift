...
class OtherArtsTableViewCell: UICollectionViewCell {
    // MARK: - Properties
    
    var artList: [ArtistArtList]?
    ...
    func updateUI(with data: ArtsData?) {
...
extension OtherArtsTableViewCell: UICollectionViewDataSource {
...
extension OtherArtsTableViewCell: UICollectionViewDelegate {
